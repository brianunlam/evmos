...
```bash
# In this example, we will set channel-292 on the cosmoshub-4 chain settings and channel-3 on the evmos_100-2 chain settings:
[[chains]]
id = 'cosmoshub-4'
...
policy = 'allow'
list = [
   ['transfer', 'channel-292'], # evmos_100-2
]
...
hermes keys restore evmos_100-2 -m "24-word mnemonic seed"
```
...
INFO ThreadId(01) [evmos_100-2] chain is healthy
```
...
```bash
hermes query packet unreceived-packets evmos_100-2 transfer channel-3
hermes query packet unreceived-acks evmos_100-2 transfer channel-3
```
...
hermes query packet commitments evmos_100-2 transfer channel-3
```
...
hermes clear packets evmos_100-2 transfer channel-3
```
...
```bash
hermes tx raw packet-recv evmos_100-2 cosmoshub-4 transfer channel-292
hermes tx raw packet-ack evmos_100-2 cosmoshub-4 transfer channel-292
hermes tx raw packet-recv cosmoshub-4 evmos_100-2 transfer channel-3
hermes tx raw packet-ack cosmoshub-4 evmos_100-2 transfer channel-3
```
